...
@bot.on_message(filters.text & ~filters.command(["start", "status", "forward", "stop", "reset", "setsource", "setdest"]))
async def auto_reply(_, m: Message):
    await m.reply("❌ Sirf commands use karo (/start)")
